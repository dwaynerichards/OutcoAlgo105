...
class LRUCache {
    ...
    //when item is at or over capacity

    //tracking: capacity, 
    //how to track least recently used
    //recently accessed, or added items are recently used
    //[1,2,3]
    //first in, first out- queue
    //if item is accessed, move to MRU/
    
    //next LRU becomes LRU
    
    //remove least recentlyused item
