...
func swap(_ head: ListNode?, _ a: Int, _ b: Int) -> ListNode? {
  ...
  func locate(_ node: ListNode?, _ target: Int) -> [ListNode?] {
    var prev: ListNode?
    var current: ListNode? = node
    while current != nil {
  ...
  if location1[0] != nil {
    location1[0]!.next = location2[1]
  }
  if location2[0] != nil {
    location2[0]!.next = location1[1]
  }
  let temp: ListNode? = location1[1]!.next
  location1[1]!.next = location2[1]!.next
  location2[1]!.next = temp
...
func isCircular(_ node: ListNode) -> Bool {
  var tortoise: ListNode? = node
  var hare: ListNode? = node
