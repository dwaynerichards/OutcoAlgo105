 ...
 */
 ...
 void dfsPreTraverse(TreeNode *current, vector<int> &result) {
 ...
 */
 ...
 void dfsInTraverse(TreeNode *current, vector<int> &result) {
   if (current == NULL) {
     return;
   }
 ...
 */
 ...
 void dfsPostTraverse(TreeNode *current, vector<int> &result) {
   if (current == NULL) {
     return;
   }
